...
(function(html) {
   ...
   const ssMoveHeader = function () {
    ...
    // Comment out the hero check or any related code that requires #intro section
    if (!hdr) return;

    window.addEventListener('scroll', function () {
        let loc = window.scrollY;
        if (loc > 50) { // Adjust trigger height
...
// end ssMoveHeader
 ...
 // end ssMobileMenu
        ...
        function navHighlight() {
            ...
            sections.forEach(function(current) {
                ...
                */
                ...
                // Ensure that navLink exists before trying to access its parentNode
                if (navLink) {
   ...
   const ssSwiper = function() {
    ...
    const testimonialsSwiper = new Swiper('.s-testimonials__slider', {  // Use 'Swiper' instead of 'ssSwiper'
        slidesPerView: 1,
        pagination: {
